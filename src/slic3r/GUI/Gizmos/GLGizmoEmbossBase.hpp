...
///|/
#ifndef slic3r_GLGizmoEmbossBase_hpp_
#define slic3r_GLGizmoEmbossBase_hpp_
...
class GLGizmoEmbossBase : public GLGizmoBase
{
public:
    enum class EmbossType { EMBOSS, REVISION };

    explicit GLGizmoEmbossBase(GLCanvas3D& parent, EmbossType emboss_type, int shortcut_key);
...
protected:
    ...
    virtual bool setup_dialog_defaults() = 0;
...
#endif // slic3r_GLGizmoEmbossBase_hpp_